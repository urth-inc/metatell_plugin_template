...
This is a template for creating a custom ChatButton for metatell.
...
The custom chat button should implement the following interface:
...
Update the package.json file to add metadata about the custom chat button. The metadata includes the name, description, and icon of the custom chat button.
...
```json
{
  ...
  "version": "0.0.1",
  "description": "A custom ChatButton"
}
```
